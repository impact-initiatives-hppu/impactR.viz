  #' ggplot2 theme wrapper with REACH fonts and colors
  #'
  ...
  theme_reach <- function(
      ...
      title_size = 16,
      title_color = color("branding_reach_grey"),
      title_font_face = "bold",
      title_hjust = NULL,
      title_position_to_plot = TRUE,
      title_font_family = "Roboto Condensed",
      text_size = 14,
      text_color = color("branding_reach_grey"),
      text_font_face = "plain",
      panel_background_color = "#FFFFFF",
      panel_border = FALSE,
      panel_border_color = color("branding_reach_grey"),
      legend_position = "bottom",
      legend_direction = "horizontal",
      legend_justification= "left",
      legend_reverse = TRUE,
      legend_title_size = 14,
      legend_title_color = color("branding_reach_grey"),
      legend_title_font_face = "plain",
      legend_text_size = 12,
      legend_text_color = color("branding_reach_grey"),
      ...
      axis_ticks_y = TRUE,
      axis_text_size = 14,
      axis_text_color = color("branding_reach_grey"),
      axis_text_font_face = "plain",
      axis_title_size = 15,
      axis_title_color = color("branding_reach_grey"),
      ...
      grid_major_x = TRUE,
      grid_major_y = FALSE,
      grid_major_color = color("branding_reach_light_grey"),
      grid_major_x_size = 0.01,
      grid_major_y_size = 0.01,
      grid_minor_x = FALSE,
      grid_minor_y = FALSE,
      grid_minor_color = color("branding_reach_light_grey"),
    ...
    # Position of title
    if (title_position_to_plot) theme <- theme +
      ggplot2::theme(
        plot.title.position = "plot"
      )

    if (caption_position_to_plot) theme <- theme +
      ggplot2::theme(
